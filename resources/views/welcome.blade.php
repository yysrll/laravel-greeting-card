    ...
    <div class="grid grid-cols-1 md:grid-cols-3">
        ...
        <div class="col-span-1 m-4 md:m-0">
            ...
            <div class="w-full my-8 flex justify-center" style="bottom: 5%">
                ...
                class="text-center w-1/2 py-4 bg-[#206EA8] border border-transparent rounded-md font-semibold text-xs text-white tracking-widest hover:bg-blue-300 focus:bg-blue-300 active:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150"
                >Mulai</a>
            </div>
