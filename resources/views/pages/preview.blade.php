        ...
        <div class="col-span-1">
            <div class="flex mb-4 mx-4 md:mx-0">
                <a href="{{ route('greetingcard.show', $id) }}"
                    ...
                    style="{{ $type == 1 ? 'border-width: 4px; border-color: transparent; border-bottom-color: rgb(96 165 250); border-radius: 0.375rem; color: rgb(59 130 246)' : ''}}"
                    >Square</a>
                <a href="{{ route('greetingcard.show', $id) }}?is_potrait=0"
                    class="w-full px-16 py-4 text-center font-semibold text-xs tracking-widest text-gray-500"
                    style="{{ $type == 0 ? 'border-width: 4px; border-color: transparent; border-bottom-color: rgb(96 165 250); border-radius: 0.375rem; color: rgb(59 130 246)' : ''}}"
                    >Potrait</a>
            </div>
